...
- **Doors & windows (German standards)** — doors follow DIN 18101 nominal sizes (610/735/860/985/1110 mm wide, 1985/2110 mm tall — interior default 860×1985). Windows default to a 0.90 m sill (Brüstungshöhe), the German fall-protection threshold. There's also a **window-door (Fenstertür)** — a full-height glazed balcony/patio door that doubles as a window, in single (900×2100) and French-double (1500×2100) sizes. Drop any of them in and drag along any wall; they stay mounted as you reshape the room.
...
- **Kitchen** — counter, sink, stove, and fridge, modeled with worktops, burners, basins, and handles, in a dedicated catalog section. Counter, sink, and stove share a 1.2 × 0.6 m module so they line up edge-to-edge in a run.
...
- **Save / load** — layouts persist in your browser via `localStorage`.
